...
function renderHeader(_ref, instance) {
  ...
  likeButton.innerHTML = '\n    ' + _icons.heart + '\n    ' + (likedReaction ? '取消喜欢' : '喜欢') + '\n    ' + (meta.reactions && meta.reactions.heart ? ' \u2022 <strong>' + meta.reactions.heart + '</strong> 个喜欢' : '') + '\n  ';
...
function renderComments(_ref2, instance) {
  ...
  if (error) {
    ...
    //   errorBlock.innerText = error;
        errorBlock.innerText = "评论貌似被GitHub吃掉了，尝试登录一下或者过会儿再试~";
    }
